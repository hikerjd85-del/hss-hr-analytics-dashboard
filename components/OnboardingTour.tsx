...
import { X, ChevronRight, ChevronLeft, Sparkles, LayoutGrid, PieChart, FileText, Search, Calendar, FlaskConical, ShieldAlert } from 'lucide-react';
...
const TOUR_STEPS = [
    ...
    },
    {
        ...
        description: 'Explore AI Copilot for natural-language workforce queries, Flight Risk Heatmap for predictive attrition analysis, and the Scenario Planner for what-if modeling.',
        icon: FlaskConical,
