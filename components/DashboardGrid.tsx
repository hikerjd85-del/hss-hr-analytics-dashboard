      ...
      <div className="max-w-7xl mx-auto px-6 py-8 animate-fade-in">
         ...
         {!searchTerm && (
            <div className="mb-10 relative">
               <h2 className="text-2xl font-extrabold text-[#002f56] dark:text-white tracking-tight mb-3">
                  {title}
               </h2>
         ...
         {searchTerm ? (
            <>
               <div className="mb-8"><h2 className="text-2xl font-bold text-slate-800 dark:text-white">Results for "{searchTerm}"</h2></div>
