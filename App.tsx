...
const App: React.FC = () => {
  ...
  if (selectedItem) {
    ...
    if (currentTab === 'overview') {
      ...
      content = <AICopilotView isDarkMode={isDarkMode} />;
    } else if (currentTab === 'flightrisk') {
      content = <FlightRiskHeatmap isDarkMode={isDarkMode} />;
    } else if (currentTab === 'scenarios') {
      content = <ScenarioCanvas isDarkMode={isDarkMode} />;
